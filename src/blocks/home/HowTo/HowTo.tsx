      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.steps}>
          <div className={styles.path}>
            <Image src='/path.svg' alt='' {...responsiveImg} />
          </div>
          <ul>
            <li>
              <div className={styles.img}>
                <Image src='/pc.svg' alt='' width={73} height={73} />
              </div>
            ...
            <li>
              <div className={styles.img}>
                <Image src='/cart.svg' alt='' width={73} height={73} />
              </div>
              <b>Покупайте</b>
            ...
            <li>
              <div className={styles.img}>
                <Image src='/heartbox.svg' alt='' width={73} height={73} />
              </div>
              <b>Получайте</b>
