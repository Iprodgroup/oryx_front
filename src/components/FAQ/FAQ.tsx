...
const FAQComponent = () => {
  ...
  <div className="static-accordions">
    <div className="static-accordion__item">
      <input type="checkbox" id="faq1" className="static-accordion__checkbox" />
    ...
    <div className="static-accordion__item">
      <input type="checkbox" id="faq2" className="static-accordion__checkbox" />
    ...
    <div className="static-accordion__item">
      <input type="checkbox" id="faq3" className="static-accordion__checkbox" />
    ...
    <div className="static-accordion__item">
      <input type="checkbox" id="faq4" className="static-accordion__checkbox" />
    ...
    <div className="static-accordion__item">
      <input type="checkbox" id="faq5" className="static-accordion__checkbox" />
    ...
    <div className="static-accordion__item">
      <input type="checkbox" id="faq6" className="static-accordion__checkbox" />
    ...
    <div className="static-accordion__item">
      <input type="checkbox" id="faq7" className="static-accordion__checkbox" />
    ...
    <div className="static-accordion__item">
      <input type="checkbox" id="faq8" className="static-accordion__checkbox" />
    ...
    <div className="static-accordion__item">
      <input type="checkbox" id="faq9" className="static-accordion__checkbox" />
